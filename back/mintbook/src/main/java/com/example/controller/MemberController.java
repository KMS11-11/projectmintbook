...
public class MemberController {
    ...
    //회원가입
    @PostMapping("/join")
    public ResponseEntity join(@RequestBody MemberDTO params) throws Exception {
    	Member member=new Member();
		member.setEmail(params.getEmail());
		member.setPassword(passwordEncoder.encode(params.getPassword()));
		member.setGender(params.getGender());
		member.setAddress(params.getAddress());
		member.setAddDetail(params.getAddDetail());
//		member.setAge(params.getAge());
		member.setName(params.getName());
		member.setPhone(params.getPhone());
		member.setBirth(params.getBirth());
